...
/* ── 3. Хуучин "Жолооч" цэс ──
   Жолооч одоо "Ажилтан" хуудсанд байгаа тул хуучин цэс давхардана. Хэрэглэхээ
   болих бол доорх мөрийг гараар ажиллуулна (автоматаар хийхгүй — тухайн орчинд
   хэн эрхтэйг мэдэхгүй):
   UPDATE menu SET active_flag = 0 WHERE component = 'pages/driver/driver.component';
*/
